...
### Reference
If you use this data/code for publication, please cite both the paper: Mandel & Broekgaarden (2021) and the dataset on Zenodo through it's doi https://zenodo.org/record/5232245 doi: [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.5143799.svg)](https://doi.org/10.5281/zenodo.5232245)
...
@MISC{ZenodoReview:2021,
     ...
     keywords = {Merger rates,  Compact object coalescence, BHBH, NSBH, NSNS, gravitational waves, double compact object},
         year = 2021,
        month = jul,
          eid = {10.5281/zenodo.5232245},
          doi = {10.5281/zenodo.5232245},
      version = {3},
    publisher = {Zenodo},
}
